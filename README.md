...
Kun Data provides real-time market data for Brazil through a token-authenticated API stack designed for charting tools, watchlists, market overview pages, brokerage dashboards, and quant workflows.

This repository focuses on Brazil market coverage with support for BMFBOVESPA.

## API Capabilities

- Real-time WebSocket market data for Brazil
...
This repository is designed to make Brazil market API coverage easier to discover and evaluate.

## Links

- Website: https://kun.pro/markets/brazil-stock-market-api
