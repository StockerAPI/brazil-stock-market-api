...
public class Main {
    ...
    private static final String MARKET = "BR";
    private static final String EXCHANGE = "BMFBOVESPA";
    private static final String SYMBOL = "BMFBOVESPA:000040";
                ...
                .buildAsync(URI.create(WS_URL), new WebSocket.Listener() {
                    ...
                    public void onOpen(WebSocket webSocket) {
                        String subscribeJson = "{\"action\":\"subscribe\",\"market\":\"" + MARKET
                                + "\",\"exchange\":\"" + EXCHANGE
                                + "\",\"symbols\":[\"BMFBOVESPA:000040\",\"BMFBOVESPA:005930\"],\"replay\":\"last\"}";
